  ...
  const handleAiQuery = async () => {
    ...
    setTimeout(() => {
      const responses: Record<string, string> = {
        'default': `**AI Learning Agent Response**\n\nBased on your query about "${aiQuery}", here's what you need to know:\n\n**Current Industry Trends (December 2025):**\n- AI Sales OS is emerging as a new category with $2.3B in VC funding this year\n- Voice-first interfaces are becoming standard (35% of enterprise sales tools now support voice)\n- SLM (Small Language Models) are replacing generic LLMs for domain-specific tasks\n\n**How SIVA OS is Positioned:**\n- First mover in AI Sales OS category\n- Multi-vertical architecture ready for scale\n- SLM roadmap for cost efficiency and speed\n\n**Recommended Learning Path:**\n1. Start with "SIVA OS Kernel" module for architecture\n2. Study "Intelligence Packs" for understanding personalization\n3. Review "Scale Behavior" for distributed systems\n\n*This response was generated by the AI Learning Agent to provide context-aware guidance.*`,
      };
