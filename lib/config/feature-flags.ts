...
const DEFAULT_FLAGS: FeatureFlag[] = [
  // ============================================================
  // S279-S329: ENTERPRISE MANAGEMENT PROGRAM v1.1 FLAGS
  // ============================================================
  {
    id: 'ff_enterprise_mode',
    key: 'enterprise_mode',
    name: 'Enterprise Mode',
    description: 'Enable enterprise management system (replaces tenant model)',
    type: 'boolean',
    status: 'disabled',
    value: { type: 'boolean', enabled: false },
    defaultValue: false,
    createdAt: new Date('2025-12-27'),
    updatedAt: new Date('2025-12-27'),
    createdBy: 'system',
    tags: ['enterprise', 'core', 's279-s329'],
    environments: [
      { environment: 'development', enabled: true, overrideValue: { type: 'boolean', enabled: true } },
      { environment: 'staging', enabled: true, overrideValue: { type: 'boolean', enabled: false } },
      { environment: 'production', enabled: false },
    ],
  },
  {
    id: 'ff_enterprise_admin_role',
    key: 'enterprise_admin_role',
    name: 'Enterprise Admin Role',
    description: 'Enable ENTERPRISE_ADMIN role and permissions',
    type: 'boolean',
    status: 'disabled',
    value: { type: 'boolean', enabled: false },
    defaultValue: false,
  ...
  },
  {
    ...
    key: 'workspaces',
    name: 'Workspaces',
    description: 'Enable workspace model for enterprise users',
    type: 'boolean',
    status: 'disabled',
    value: { type: 'boolean', enabled: false },
    defaultValue: false,
    ...
    updatedAt: new Date('2025-12-27'),
    createdBy: 'system',
    tags: ['enterprise', 'workspaces', 's283'],
    environments: [
      { environment: 'development', enabled: true, overrideValue: { type: 'boolean', enabled: true } },
      { environment: 'staging', enabled: false },
      { environment: 'production', enabled: false },
  ...
  {
    id: 'ff_demo_policy_system',
    key: 'demo_policy_system',
    name: 'Demo Policy System',
    description: 'Enable config-driven demo policies (no hardcoding)',
    type: 'boolean',
    status: 'disabled',
    value: { type: 'boolean', enabled: false },
    defaultValue: false,
  ...
  {
    id: 'ff_enterprise_rls',
    key: 'enterprise_rls',
    name: 'Enterprise RLS',
    description: 'Enable enterprise_id RLS policies (replaces tenant_id)',
    type: 'boolean',
    status: 'disabled',
    value: { type: 'boolean', enabled: false },
    defaultValue: false,
    ...
    updatedAt: new Date('2025-12-27'),
    createdBy: 'system',
    tags: ['enterprise', 'security', 's298a'],
    environments: [
      { environment: 'development', enabled: true, overrideValue: { type: 'boolean', enabled: true } },
      { environment: 'staging', enabled: false },
      { environment: 'production', enabled: false },
  ...
  },
  {
    ...
    key: 'ai_briefs',
    name: 'AI Briefs',
    description: 'Enable AI-generated briefs for Super Admin and Enterprise Admin',
    type: 'boolean',
    status: 'disabled',
    value: { type: 'boolean', enabled: false },
    defaultValue: false,
  ...
  {
    id: 'ff_evidence_packs',
    key: 'evidence_packs',
    name: 'Evidence Packs',
    description: 'Enable evidence pack generation from BTE aggregates',
    type: 'boolean',
    status: 'disabled',
    value: { type: 'boolean', enabled: false },
    defaultValue: false,
  ...
  // S57 Feature Flags - UI Enhancements
  {
    id: 'ff_map_zoom_controls',
    key: 'map_zoom_controls',
    name: 'Map Zoom Controls',
    description: 'Enhanced map zoom controls with pinch-to-zoom support',
    type: 'plan_based',
    status: 'enabled',
    value: { type: 'plan_based', enabledPlans: ['starter', 'professional', 'enterprise'] },
    defaultValue: false,
  ...
  {
    id: 'ff_gesture_navigation',
    key: 'gesture_navigation',
    name: 'Gesture Navigation',
    description: 'Swipe gestures for navigation and quick actions',
    type: 'plan_based',
    status: 'enabled',
    value: { type: 'plan_based', enabledPlans: ['starter', 'professional', 'enterprise'] },
    defaultValue: false,
  ...
  },
  {
    ...
    key: 'thread_view',
    name: 'Thread View',
    description: 'Threaded conversation view for outreach messages',
    type: 'plan_based',
    status: 'enabled',
  ...
  {
    id: 'ff_custom_dashboards',
    key: 'custom_dashboards',
    name: 'Custom Dashboards',
    description: 'Create and customize personal dashboards',
    type: 'plan_based',
    status: 'enabled',
    value: { type: 'plan_based', enabledPlans: ['enterprise'] },
    defaultValue: false,
    createdAt: new Date('2025-11-30'),
    updatedAt: new Date('2025-11-30'),
    createdBy: 'system',
    tags: ['ui', 'dashboards', 's57'],
    environments: [
      { environment: 'development', enabled: true },
      { environment: 'staging', enabled: true },
      { environment: 'production', enabled: true },
